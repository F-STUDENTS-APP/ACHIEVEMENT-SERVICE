...
WORKDIR /app/achievement-service

# Copy package files
COPY achievement-service/package*.json ./
COPY achievement-service/tsconfig.json ./
COPY achievement-service/prisma ./prisma

# Install dependencies
RUN npm install --registry=https://registry.npmjs.org/

# Copy source code
COPY achievement-service .
...
COPY --from=builder /app/achievement-service/dist ./dist
